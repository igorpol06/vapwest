...
class SaleOrder(models.Model):
    ...
    def unlink(self):
        mappings = self.env['connector.order.mapping'].search([('odoo_order_id', 'in', self.ids)])
        self.env['connector.snippet'].delete_connector_mapping('connector.order.mapping', self, 'Order', mappings)
        return super().unlink()
