...
class ResPartner(models.Model):
    ...
    def unlink(self):
        mappings = self.env['connector.partner.mapping'].search([('name', 'in', self.ids)])
        self.env['connector.snippet'].delete_connector_mapping('connector.partner.mapping', self, 'Customer', mappings)
        return super().unlink()
